...
module.exports = {
    ...
    safelist: [
        "focus:qfdmo-ring-beige-gris-galet",
        "focus:qfdmo-ring-blue-cumulus",
        "focus:qfdmo-ring-blue-ecume",
        "focus:qfdmo-ring-brown-cafe-creme",
        "focus:qfdmo-ring-brown-caramel",
        "focus:qfdmo-ring-brown-opera",
        "focus:qfdmo-ring-green-500",
        "focus:qfdmo-ring-green-archipel",
        "focus:qfdmo-ring-green-bourgeon",
        "focus:qfdmo-ring-green-emeraude",
        "focus:qfdmo-ring-green-menthe",
        "focus:qfdmo-ring-green-tilleul-verveine",
        "focus:qfdmo-ring-orange-terre-battue",
        "focus:qfdmo-ring-pink-macaron",
        "focus:qfdmo-ring-pink-tuile",
        "focus:qfdmo-ring-purple-glycine",
        "focus:qfdmo-ring-red-500",
        "focus:qfdmo-ring-yellow-moutarde",
        "focus:qfdmo-ring-yellow-tournesol",
        "qfdmo-accent-beige-gris-galet",
        "qfdmo-accent-blue-cumulus",
        "qfdmo-accent-blue-ecume",
        "qfdmo-accent-brown-cafe-creme",
        "qfdmo-accent-brown-caramel",
        "qfdmo-accent-brown-opera",
        "qfdmo-accent-green-500",
        "qfdmo-accent-green-archipel",
        "qfdmo-accent-green-bourgeon",
        "qfdmo-accent-green-emeraude",
        "qfdmo-accent-green-menthe",
        "qfdmo-accent-green-tilleul-verveine",
        "qfdmo-accent-orange-terre-battue",
        "qfdmo-accent-pink-macaron",
        "qfdmo-accent-pink-tuile",
        "qfdmo-accent-purple-glycine",
        "qfdmo-accent-red-500",
        "qfdmo-accent-yellow-moutarde",
        "qfdmo-accent-yellow-tournesol",
