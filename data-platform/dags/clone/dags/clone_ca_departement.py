...
with DAG(
    dag_id="clone_ca_departement",
    dag_display_name="Cloner - Contours Administratifs - Département",
    default_args=DEFAULT_ARGS_NO_RETRIES,
    schedule=SCHEDULES.EVERY_SUNDAY_AT_01_00,
    start_date=START_DATES.DEFAULT,
    description=(
        "Clone le jeu de données 'departements' de Contours Administratifs dans notre"
        " DB"
    ),
    tags=[
        TAGS.ENRICH,
    ...
    params={
        ...
        "data_endpoint": Param(
            (
                ...
                "latest/geojson/departements-50m.geojson.gz"
            ),
            type="string",
