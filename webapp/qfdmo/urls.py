...
from qfdmo.views.autocomplete import (
    ...
    AutocompleteFormulaireSynonymeView,
)
...
urlpatterns = [
    ...
    path(
        "qfdmo/autocomplete/synonyme-formulaire",
        AutocompleteFormulaireSynonymeView.as_view(),
        name="autocomplete_synonyme_formulaire",
    ),
    path(
