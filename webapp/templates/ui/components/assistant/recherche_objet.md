...
Le composant émet `assistant-combobox:chosen` avec
`{ label, slug }` quand l'usager retient une suggestion.
...
`static debounces = [{ name: "search", wait: 150 }]`. Assez court pour rester
