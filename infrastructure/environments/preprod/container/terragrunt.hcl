...
inputs = {
  # Scheduler
  airflow_scheduler_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-scheduler:pr-1838"
  ...
  # Webserver
  airflow_webserver_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-webserver:pr-1838"
