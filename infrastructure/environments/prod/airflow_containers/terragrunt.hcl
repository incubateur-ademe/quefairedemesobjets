...
inputs = {
  # Scheduler
  airflow_scheduler_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-scheduler:<TAG>"
  ...
  # Webserver
  airflow_webserver_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-webserver:<TAG>"
  ...
  # DAG processor
  airflow_dag_processor_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-dag-processor:<TAG>"
  airflow_dag_processor_cpu_limit      = 1000
  airflow_dag_processor_memory_limit   = 1024
  airflow_dag_processor_min_scale      = 1
  airflow_dag_processor_max_scale      = 1
  airflow_dag_processor_timeout        = 300

  AIRFLOW__WEBSERVER__INSTANCE_NAME   = "‼️‼️‼️‼️ PROD ‼️‼️‼️‼️"
  AIRFLOW__DATABASE__SQL_ALCHEMY_CONN = "postgresql://${dependency.database.outputs.airflow_db_admin_username}:${dependency.database.outputs.airflow_db_admin_password}@${dependency.database.outputs.airflow_endpoint_ip}:${dependency.database.outputs.airflow_endpoint_port}/${dependency.database.outputs.airflow_database_name}"
  AIRFLOW_METADATA_DB_URL             = "postgresql+psycopg2://${dependency.database.outputs.airflow_db_admin_username}:${dependency.database.outputs.airflow_db_admin_password}@${dependency.database.outputs.airflow_endpoint_ip}:${dependency.database.outputs.airflow_endpoint_port}/${dependency.database.outputs.airflow_database_name}"
  AIRFLOW_CONN_WEBAPP_DB              = "postgres://${dependency.database.outputs.webapp_db_admin_username}:${dependency.database.outputs.webapp_db_admin_password}@${dependency.database.outputs.webapp_endpoint_ip}:${dependency.database.outputs.webapp_endpoint_port}/${dependency.database.outputs.webapp_database_name}?sslmode=require"
  DATABASE_URL                        = "postgres://${dependency.database.outputs.webapp_db_admin_username}:${dependency.database.outputs.webapp_db_admin_password}@${dependency.database.outputs.webapp_endpoint_ip}:${dependency.database.outputs.webapp_endpoint_port}/${dependency.database.outputs.webapp_database_name}?sslmode=require"
  DB_WAREHOUSE                        = "postgres://${dependency.database.outputs.warehouse_db_admin_username}:${dependency.database.outputs.warehouse_db_admin_password}@${dependency.database.outputs.warehouse_endpoint_ip}:${dependency.database.outputs.warehouse_endpoint_port}/${dependency.database.outputs.warehouse_database_name}?sslmode=require"
