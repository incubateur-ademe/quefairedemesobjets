...
inputs = {
  # Scheduler
  airflow_scheduler_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-scheduler:v9.10.0"
  ...
  # Webserver
  airflow_webserver_registry_image = "rg.fr-par.scw.cloud/ns-qfdmo/airflow-webserver:v9.10.0"
  ...
  AIRFLOW__WEBSERVER__INSTANCE_NAME   = "🔴🔴🔴 ENV de PROD ! 🔴🔴🔴"
