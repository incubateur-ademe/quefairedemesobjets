...
class TestChangeActeurDeleteAsParent:
    ...
    def test_raise_if_present(self):
        ...
        change = ChangeActeurDeleteAsParent(identifiant_unique="p1")
    ...
    def test_ensure_deletion_is_automatic(self):
        ...
        ChangeActeurCreateAsParent(identifiant_unique="p1").apply()
        ActeurFactory(identifiant_unique="a1")
        ActeurFactory(identifiant_unique="a2")
        data = {"parent_id": "p1"}
        ChangeActeurUpdateParentId(identifiant_unique="a1", data=data).apply()
        ChangeActeurUpdateParentId(identifiant_unique="a2", data=data).apply()
        ...
        ChangeActeurCreateAsParent(identifiant_unique="p2").apply()
        data = {"parent_id": "p2"}
        ChangeActeurUpdateParentId(identifiant_unique="a1", data=data).apply()
        ...
        ChangeActeurDeleteAsParent(identifiant_unique="p1").apply()
