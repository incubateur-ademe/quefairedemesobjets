...
AND (
  warehouse.udf_normalize_string_for_match(acteurs.ville,3) = warehouse.udf_normalize_string_for_match(ban.ville_ancienne,3)
  OR warehouse.udf_normalize_string_for_match(acteurs.ville,3) = warehouse.udf_normalize_string_for_match(ban.ville,3)
)
