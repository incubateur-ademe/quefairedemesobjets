...
WITH potential_replacements AS (
	SELECT
		...
		-- Matching
		warehouse.udf_columns_words_in_common_count(
			candidates.acteur_nom_normalise,
			warehouse.udf_normalize_string_for_match(suggests.nom)
	...
	*/
	...
	AND warehouse.udf_normalize_string_for_match(suggests.adresse) = warehouse.udf_normalize_string_for_match(candidates.etab_adresse)
