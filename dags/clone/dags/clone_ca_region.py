...
with DAG(
    dag_id="clone_ca_region",
    dag_display_name="Cloner - Contours Administratifs - Région",
    default_args=DEFAULT_ARGS_NO_RETRIES,
    schedule=SCHEDULES.EVERY_SUNDAY_AT_01_00,
    start_date=START_DATES.DEFAULT,
    description=(
        "Clone le jeu de données 'regions' de Contours Administratifs dans notre DB"
    ),
    tags=[
        TAGS.ENRICH,
        TAGS.CLONE,
    ...
    params={
        ...
        "data_endpoint": Param(
            (
                ...
                "latest/geojson/regions-50m.geojson.gz"
            ),
            type="string",
