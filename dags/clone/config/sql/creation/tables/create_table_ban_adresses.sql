...
Schema generated by scripts/db_schema_create_from_csv.py
  - 🔴 Column we might want to drop post import is cad_parcelles
*/

CREATE TABLE {{table_name}} (
  "id" VARCHAR(28), -- 🟡 on reste scrict sur max (des IDs avec 16)
  "id_fantoir" CHAR(10), -- 🟡 on reste scrict (min/max=10)
  ...
  "certification_commune" CHAR(1), -- 🟡 on reste scrict (min/max=1)
  "cad_parcelles" TEXT
);
...
🔴 Can't use primary key on "id" as of 2025-03-24 contains duplicates:
