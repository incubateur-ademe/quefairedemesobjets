...
def crawl_urls_suggestions_to_db_wrapper(params, ti, dag, run_id) -> None:
...
def crawl_urls_suggestions_to_db_task(dag: DAG) -> PythonOperator:
    return PythonOperator(
        task_id=TASKS.SUGGESTIONS_TO_DB,
        python_callable=crawl_urls_suggestions_to_db_wrapper,
        dag=dag,
    )
