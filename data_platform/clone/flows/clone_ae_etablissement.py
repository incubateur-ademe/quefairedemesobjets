...
def clone_ae_etablissement(
    dry_run: bool = False,
    table_kind: str = "ae_etablissement",
    data_endpoint: str = (
    ...
    file_downloaded: str = "StockEtablissement_utf8.zip",
    file_unpacked: str = "StockEtablissement_utf8.csv",
    delimiter: str = ",",
) -> None:
    """
    ...
    """
    log.info("Démarrage du flow clone_ae_etablissement")
