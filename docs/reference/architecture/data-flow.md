...
| **Application des suggestions** | Application des suggestions validées par l'équipe : DAGs Airflow (`apply_suggestions*`) et actions admin Django sur les `SuggestionGroupe` (django-tasks pour les gros volumes). | [`data-platform/airflow.md`](../data-platform/airflow.md), [`webapp/django.md`](../webapp/django.md)   |
